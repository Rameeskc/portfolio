...
import {FaBars,FaTimes} from"react-icons/fa"
 const NavBar = () => {
  ...
  return (
    <div className="flex justify-between bg-black text-white h-20 w-full items-center px-4">
      <div>
        <h1 className='text-white text-5xl font-extrabold font-signature'>Ramees</h1>
      </div>  
